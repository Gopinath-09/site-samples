...
export default function FinalCta() {
  return (
    <Section container={false} className="pb-32">
      ...
      <div
        aria-hidden
        className="text-wave pointer-events-none absolute -bottom-2 left-1/2 z-10 -translate-x-1/2 select-none text-6xl font-extrabold tracking-[0.15em] md:text-8xl"
      >
        COBRR
      </div>
    </Section>
